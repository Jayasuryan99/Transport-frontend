      ...
      <div className="flex  pl-10 pt-2 text-[14px]">
        ...
        <div className="flex flex-col items-center w-[85%]">
          ...
          <p>  H.O :  No.4/181,Plot No. 8,1st Floor Sri Ram Tower,Thuraiyur Road,Anna Nagar,NAMAKKAL-637 002.
               B.O : Shop No.1, H.No.:5-29/2, Near Railway Bridge, NH-44, Thondupally(V), Shamsabad(M), Ranga Reddy District- 509 325. HYDERABAD(TS) Cell:91525 25000, 91525 26000 E-Mail:hydjaibalaji@gmail.com</p>
        </div>
      </div>
      <div>
